    ...
    <Section
      ...
      lead={
        <>
          {'ゲーム内素材だけでは終わりません。'}
          <br />
          {'Steamストアの各規格・SNS告知・動画まで、同じキャラクターのまま書き出します。'}
          <br />
          {'媒体ごとに絵柄がブレることはありません。'}
        </>
      }
          ...
          <div className="grid grid-cols-[2fr_1fr] gap-4">
            <div className="flex flex-col gap-4">
              <div>
                ...
                />
                <p className="mt-1.5 text-sm text-mute">ヘッダーカプセル 460×215</p>
              </div>
              <div>
                <Placeholder
                ...
                />
                <p className="mt-1.5 text-sm text-mute">メインカプセル 616×353</p>
              </div>
            </div>
            <div>
              <Placeholder
              ...
              />
              <p className="mt-1.5 text-sm text-mute">ライブラリ縦型 600×900</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-[2fr_1fr] gap-4">
            ...
            <div>
              ...
              <p className="mt-1.5 text-sm text-mute">縦型動画 9:16</p>
            </div>
          </div>
        </div>
      </div>
